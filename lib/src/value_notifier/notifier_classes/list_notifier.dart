...
class ListNotifier<E> extends ValueNotifier<List<E>> implements List<E> {
  /// Creates a notifier backed by [initial].
  ListNotifier(List<E> initial) : super(List<E>.from(initial));

  ListNotifier._raw(super.initial);
  ...
  factory ListNotifier.generate(
    ...
    bool growable = true,
  }) => ListNotifier._raw(List.generate(length, generator, growable: growable));

  /// Creates a list with [length] entries, each initialized to [fill].
  factory ListNotifier.filled(int length, E fill, {bool growable = false}) {
    return ListNotifier._raw(List.filled(length, fill, growable: growable));
  }

  /// Creates an empty list notifier.
  factory ListNotifier.empty({bool growable = false}) {
    return ListNotifier._raw(List.empty(growable: growable));
  }

  /// Creates a list containing all [elements].
  factory ListNotifier.from(Iterable<E> elements, {bool growable = true}) {
    return ListNotifier._raw(List.from(elements, growable: growable));
  }

  /// Creates a list from [elements].
  factory ListNotifier.of(Iterable<E> elements, {bool growable = true}) {
    return ListNotifier._raw(List.of(elements, growable: growable));
  }

  /// Creates an unmodifiable list containing all [elements].
  factory ListNotifier.unmodifiable(Iterable<E> elements) {
    return ListNotifier._raw(List.unmodifiable(elements));
  }
  ...
  /// Clones the current list so listeners are notified after in-place changes.
  void refresh() {
    final list = value;
    final newList = [...list];
    value = newList;
  ...
  /// Executes [action] against the current list and refreshes afterward.
  ///
  /// This acts as an explicit notification boundary for in-place or nested
  /// mutations that do not replace the list instance.
  R mutate<R>(R Function(List<E> list) action) {
  ...
  int indexWhere(bool Function(E element) test, [int start = 0]) =>
      mutate((list) => list.indexWhere(test, start));
  ...
  int lastIndexWhere(bool Function(E element) test, [int? start]) =>
      mutate((list) => list.lastIndexWhere(test, start));
  ...
  ListNotifier<E> operator +(List<E> other) {
    return ListNotifier<E>(List<E>.of(value)..addAll(other));
  }
  ...
  ListNotifier<E> sublist(int start, [int? end]) {
    return ListNotifier<E>(value.sublist(start, end));
  }
  ...
  void forEach(void Function(E element) action) {
    mutate((list) => list.forEach(action));
  }
  ...
  E reduce(E Function(E value, E element) combine) {
    return mutate((list) => list.reduce(combine));
  }
  ...
  T fold<T>(T initialValue, T Function(T previousValue, E element) combine) {
    return mutate((list) => list.fold(initialValue, combine));
  }
  ...
  /// ```
  @override
  bool any(bool Function(E element) test) => mutate((list) => list.any(test));
  ...
  E firstWhere(bool Function(E element) test, {E Function()? orElse}) =>
      mutate((list) => list.firstWhere(test, orElse: orElse));
  ...
  E lastWhere(bool Function(E element) test, {E Function()? orElse}) =>
      mutate((list) => list.lastWhere(test, orElse: orElse));
  ...
  E singleWhere(bool Function(E element) test, {E Function()? orElse}) =>
      mutate((list) => list.singleWhere(test, orElse: orElse));
  ...
  ListNotifier<E> toList({bool growable = true}) {
    return ListNotifier<E>(value.toList(growable: growable));
  }
  ...
  bool isEqual(List<E> other) => listEquals(value, other);
}
