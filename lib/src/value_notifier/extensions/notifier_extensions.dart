...
import 'package:better_value_notifier/notifier_classes.dart';
...
/// Extension on [Duration] to provide easy access to creating a
/// [ValueNotifier] for duration values.
extension FHUDurationNotifierEx on Duration {
  /// Creates a [DurationNotifier] instance from the current [Duration] value.
  DurationNotifier get notifier => DurationNotifier(this);
}
...
/// Extension on `Iterable<E>` to provide easy access to collection
/// [ValueNotifier] instances.
