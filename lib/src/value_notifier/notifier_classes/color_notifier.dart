...
class ColorNotifier extends ValueNotifier<Color> {
  /// Creates a notifier that stores a [Color] value.
  ...
  /// Re-emits the current color without replacing it.
...
extension FHUColorValueNotifierExtension on ValueListenable<Color> {
  ...
  ///
  /// Out of range values will have unexpected effects.
  Color withOpacity(double opacity) => value.withValues(alpha: opacity);
